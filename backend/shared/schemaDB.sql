...
--
ALTER TABLE Ideal_Inventory ADD COLUMN IF NOT EXISTS date TIMESTAMP;
--
ALTER TABLE Needed_Inventory ADD COLUMN IF NOT EXISTS date TIMESTAMP;
--
ALTER TABLE Future_Supplied ADD COLUMN IF NOT EXISTS date TIMESTAMP;
